...
void GameApplication::createVkInstance() {
    if (enableValidationLayers && !checkValidationLayerSupport()) {
        throw std::runtime_error("Validation Layer Required !");
    }
...
VkSurfaceFormatKHR GameApplication::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR> &availableFormats) {
...
VkPresentModeKHR GameApplication::chooseSwapPresentMode(const std::vector<VkPresentModeKHR> &availablePresentModes) {
...
VkExtent2D GameApplication::chooseSwapExtent(const VkSurfaceCapabilitiesKHR &capabilities) {
...
void GameApplication::createSwapChain() {
...
void GameApplication::createImageViews() {
    ...
    LOGLN("Created image Views");
}

void GameApplication::createGraphicsPipeline() {
    ...
    LOGLN("Created Graphics Pipeline");

}

void GameApplication::createRenderPass() {
    ...
    LOGLN("Created Render Pass");
}

void GameApplication::createFrameBuffers() {
    ...
    LOGLN("Created Framebuffers");
}

void GameApplication::createCommandPool() {
    ...
    LOGLN("Created Command Pool");
}

void GameApplication::createCommandBuffer() {
    ...
    LOGLN("Created Command Buffer");
}

void GameApplication::createSyncObjects() {
    ...
    LOGLN("Created Semaphores & Fences");
}

void GameApplication::createVertexBuffer() {
    ...
    LOGLN("Created Vertex Buffer");
}

void GameApplication::createIndexBuffer() {
    ...
    vkDestroyBuffer(device, stagingBuffer, nullptr);
    vkFreeMemory(device, stagingBufferMemory, nullptr);
    LOGLN("Created Index Buffer");
}

void GameApplication::createDescriptorSetLayout() {
    ...
    LOGLN("Created descriptor set layout");
...
void GameApplication::updateUniformBuffer(uint32_t currentImage) {
...
void GameApplication::createDescriptorPool() {
    ...
    LOGLN("Created descriptor pool");
}

void GameApplication::createDescriptorSets() {
...
void GameApplication::createBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties,
    ...
    LOGLN("Allocated memory to buffer");

    vkBindBufferMemory(device, buffer, bufferMemory, 0);

}

void GameApplication::copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size) {
    VkCommandBufferAllocateInfo allocInfo{};
    allocInfo.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_ALLOCATE_INFO;
    allocInfo.level = VK_COMMAND_BUFFER_LEVEL_PRIMARY;
    allocInfo.commandPool = commandPool;
...
uint32_t GameApplication::findMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties) {
    ...
    LOGLN("Failed to find suitable memory type");
...
VkShaderModule GameApplication::createShaderModule(const std::vector<char> &code) {
...
std::vector<const char *> GameApplication::getRequiredExtensions() {
